...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="jskeyboard.css" />
    <script type="text/javascript" src="jskeyboard.js" ></script>
</head>
<body>
    <header>
        <h1>Javascript Keyboard Page</h1>
        <ul class="navbar">
            ...
            <li><a href="jsmouse.html">JavaScript Mouse</a></li>
            <li><a id="active" href="jskeyboard.html">JavaScript Keyboard</a></li>            
